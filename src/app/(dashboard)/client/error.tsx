...
export default function ClientError({
  ...
  return (
    <div className="flex flex-col items-center gap-3 rounded-2xl bg-zone px-6 py-16 text-center">
      ...
      <p className="text-sm font-medium text-foreground">We could not load this page</p>
      <p className="max-w-[42ch] text-xs text-muted-foreground">
        This is usually a weak connection and passes quickly. Try again, or message us on WhatsApp if it keeps happening.
      </p>
