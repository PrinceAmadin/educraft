...
export const metadata: Metadata = { title: "Ambassador slots" };
export const dynamic = "force-dynamic";

export default async function AmbassadorSlotsPage() {
  ...
  return (
    <div className="space-y-7">
      ...
      />
      <AmbassadorTabs active="roster" pendingApplications={pendingApplications} />
