...
// Cleanup deletes Zotero items and Drive files from the previous run.
export const maxDuration = 60;

/** Discards this assignment's research job (and what it created in Zotero/Drive) so it can be run again. */
