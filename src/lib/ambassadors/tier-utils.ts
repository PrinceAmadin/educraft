...
/**
 * Active: a conversion in the last 30 days. Dormant: the last one was 30–60
 * days ago. Inactive: 60+ days (or never, for someone who joined over 30 days
 * ago). New: joined within 30 days with no conversion yet. Computed from the
