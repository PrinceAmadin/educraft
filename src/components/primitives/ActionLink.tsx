 ...
 * Actions.
 *
 * Shape language: the primary action carries a cut bottom-right corner — the
 * same clipped corner used on the paper compositions elsewhere on the page.
 * It is a brand mark, not a rounded-rectangle default, and it ties the button
 * to the document metaphor the rest of the page is built on.
 *
